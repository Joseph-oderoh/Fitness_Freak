...
@nutrition.route('/createpost', methods=['GET', 'POST'])
##@login_required
def new_post():
    form = FormPost()
...
@nutrition.route('/post/<post_id>', methods=['GET', 'POST'])
def post(post_id):
    post=Post.query.filter_by(id=post_id).first()
    print(post)
    return render_template('nutpost.html',post=post)


@nutrition.route('/post/<post_id>/update',methods=['GET', 'POST'])
#@login_required
...
@nutrition.route('/post/<post_id>/delete',methods=['GET', 'POST'])
#@login_required
...
@nutrition.route('/comments/<post_id>', methods=['GET', 'POST'])
##@login_required
...
@nutrition.route('/comment/<comment_id>', methods=['POST','GET'])
